...
class Platform extends BaseService implements IPlatform {
	...
	public function addWebBlock(
		$is_display, $block_color, $sort, $block_name, $block_short_name, $recommend_ad_image_name, $recommend_ad_image, $recommend_ad_slide_name, $recommend_ad_slide,
   ...
   //         $list = $this->setReturnList($queryList, $queryCount, $page_size);
	...
	public function modifyGoodsRecommend( $goods_id, $type, $is_recommend ) {
		...
		if ( $is_recommend == 1 ) {
			...
			if ( $count > 0 ) {
				$retval = $platform_goods_recommend->save( [ 'state' => 1 ], [
					'goods_id' => $goods_id,
					'class_id' => $type
				] );
			} else {
