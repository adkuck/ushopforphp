...
return [
    ...
    // 默认模块名, 比如shop,wap,admin；参照application下的模块，一个文件夹就是一个模块
    'default_module' => 'shop',
    // 禁止访问模块
    'deny_module_list' => [
        'common'
    ...
    'view_replace_str' => array(
        ...
        'UPLOAD_ADV' => UPLOAD . '/image_collection/', // //存放广告位图片，由于原“advertising”文件夹名称会被过滤掉。 修改为“image_collection”
    ...
    'captcha' => [
        ...
        // ushop2017459ABCDEFGHJKLMNQRTVWXYZ
        // 验证码字符集合
        'codeSet' => '0123456789',
        // 验证码字体大小(px)
        'fontSize' => 15,
